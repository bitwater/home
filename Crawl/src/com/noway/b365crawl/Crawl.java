...
import com.noway.b365crawl.fetcher.Fetcher;
import com.noway.b365crawl.fetcher.FetcherThreadRunnable;
import com.noway.b365crawl.fetcher.FetcherUtils;
...
public class Crawl {
	...
	public void run() {
		...
		System.out.println("documents.size:" + documents.size() + new Date().toLocaleString());
